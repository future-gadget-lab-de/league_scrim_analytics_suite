...
class LeagueDataManager:
    ...
    def __init__(self):
        ...
        self.tables = {
            "client": {
                GameTable.META: pd.read_csv("saved/metadata_client.csv"),
                GameTable.TEAM: pd.read_csv("saved/teamdata_client.csv"),
                GameTable.PLAYER: pd.read_csv("saved/teamdata_client.csv")
            },
            "matchv5": {
                GameTable.META: pd.read_csv("saved/metadata_match.csv"),
                GameTable.TEAM: pd.read_csv("saved/teamdata_match.csv"),
                GameTable.PLAYER: pd.read_csv("saved/teamdata_match.csv")
            }
        }
    ...
    def updateManager(self):
        ...
        self.recent_tables = self.tables[mode]
